<!-- footer -->
<footer class="footer layout-footer layout-footer--contact">
  <?php
    ...
    <div class="footer__flex">
      <div class="footer__info">
        ...
        <address class="footer__address">
          &#12306;<?php the_field('company_zip_code', $front_id); ?><br>
          <?php echo nl2br(esc_html(get_field('company_address', $front_id))); ?><br>
          <?php echo esc_html(get_field('company_building', $front_id)); ?>
        </address>
        <?php endif; ?>
      </div>
